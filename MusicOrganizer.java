...
public class MusicOrganizer
{
    ...
    public void playTrack(int index)
    {
        if(indexValid(index) && !sounding) {
            ...
            System.out.println("Reproducción en curso, no es posible reproducir un nuevo archivo.");
        }
    }
    ...
    /**
     * Permite eliminar de la lista de tracks los que contengan al artista determinado en el parámetro del método.
     */
    ...
    /**
     * Permite eliminar de la lista de tracks los que contengan el título determinado en el parámetro del método.
     */
